...
export const Maps: Record<string, MapDefinition> = {
    main: {
        ...
        buildings: {
            port_complex: Math.floor(Math.random() * 5) + 1,
            armory: Math.floor(Math.random() * 5) + 2,
            mobile_home: Math.floor(Math.random() * 5) + 2,
            refinery: Math.floor(Math.random() * 5) + 3,
            warehouse: Math.floor(Math.random() * 5) + 1,
            small_house: Math.floor(Math.random() * 5) + 1,
            porta_potty: Math.floor(Math.random() * 5) + 5,
            container_3: Math.floor(Math.random() * 5) + 1, 
            container_4: Math.floor(Math.random() * 5) + 6, 
            container_5: Math.floor(Math.random() * 5) + 1, 
            container_6: Math.floor(Math.random() * 5) + 1, 
            container_7: Math.floor(Math.random() * 5) + 2, 
            container_8: Math.floor(Math.random() * 5) + 1, 
            container_9: Math.floor(Math.random() * 5) + 1, 
            container_10: Math.floor(Math.random() * 5) + 1 
        },
        obstacles: {
            oil_tank: 10,
